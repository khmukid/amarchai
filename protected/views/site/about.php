...
<div class="pm-sub-header-container pm-parallax-panel" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
    ...
    <div class="pm-sub-header-title-container">
        ...
        <p class="pm-sub-header-message">Few Little Word About Us</p>
    </div>
...
<div class="container pm-containerPadding-top-60">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <p>
                Amar chai Venue is a platform of types of venues in Bangladesh. This venture basically concentrates on providing quality service to general people to corporate person to find out their desired venue according to their need. 
            </p>
            <p>Coverage</p>
            <p>Commitment</p>
        ...
        <div class="col-lg-12">
            ...
            <p>
                ‘Amar Chai Venue’ is an online based venue booking service. Through this platform, one can simply be informed about the detail of a venue and book it from anywhere from Bangladesh. If you have interest to arrange an upcoming event, you can get your estimated cost from here. You can also get different quote from different venues. In addition, you can choose the best venue by comparing it with the other venues!
            </p>
            <p>
                Venue booking service is now more lucrative and easy to access. Every single venue is now have it’s own online address! *skipped* From now on, venue managers can maintain their calendar of activities from here if they want to. They can set price according to the want of their customers too.
            </p>
            <p>
                ‘Amar Chai Venue’ is the first and the biggest venue based service. Not only the capital city Dhaka, can you also get all sort of information of every sort of venues from the other divisional districts & other.
            </p>
            <p>
                In this competitive world, to ensure the best customer service....
            </p>
        </div>
    </div>
</div>
